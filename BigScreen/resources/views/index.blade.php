    ...
    <div class="form-group">
      @foreach($questions as $question)
        ...
        @elseif($question->text == 'Votre âge')
          <input type="number" class="form-control input-style" name="{{$question->id}}" min="1" max="150" required>
        ...
        @elseif($question->type === "varchar" && $question->text !== 'Votre adresse mail') 
          <input type="text" class="form-control input-style" name="{{$question->id}}" required>
